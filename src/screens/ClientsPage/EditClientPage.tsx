...
export const EditClientPage = (): JSX.Element => {
          ...
          <form onSubmit={handleSubmit}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              ...
              <Autocomplete
                ...
                value={availableFeatureFlags.filter(flag => formData.featureFlags.includes(flag.id))}
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <TextField
                  ...
                  error={!!hostnameError}
                  helperText={hostnameError || "Hostname has to be unique if the value is set, or you can leave it as empty."}
                />
                <FormControlLabel
                  control={
                    <Switch
